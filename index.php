                ...
                <div class="modal-body">
                    <div class="body_regaistrasi">
                        <form method="post">
                            ...
                            <label></label>
                            <div class="">
                                <select class="select" name=" platfrom" required>
                            ...
                            <div class="input-group">
                                <button type="submit btn" class="btn border-top-color main__btn2 " name="reg_user">Kirim
                                    Permintaan
                                </button>
                            </div>
                        </form>
...
gradeField3.addeventListener("invalid", function() {
    this.setCostumValidity("");
    if (!this.validity.valid) {
        this.setCustomValidity('masukan kembali password')
    }
});
</script>
